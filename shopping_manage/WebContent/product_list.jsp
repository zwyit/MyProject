				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							...
							<a href="QueryProductServlet">商品列表</a>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<button id="sample_editable_1_new" class="btn green" onclick="toAdd()">
									...
									<tbody>
										...
										<c:forEach items="${products}" var="product">
											<tr align="center" valign="middle">
												...
												<td class="hidden-480">${product.price}</td>
												<td class="center hidden-480">${product.count}</td>
